...
if __name__ == '__main__':
    with open('data/data.json') as json_file:  
        ...
        directions = {'Lausanne-Flon', 'Renens VD, gare'}
        sorted_data = filter_data(data, directions)
        for line in sorted_data:
            for direction in sorted_data[line]:
                print(line + ' to ' + direction + ':' + ' '.join(sorted_data[line][direction]))
